...
<form method="get">
    ...
    <label>Course Title:</label><input type="text" name="course-title"><input type="submit" value="Submit">
    ...
    <input class="add-single" id="add-prereq" label="prereq" type="button" value="add pre-requiste course"><br>
