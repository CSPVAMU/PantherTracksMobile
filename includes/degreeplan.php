...
$classes[0][6]="0"; //$prereqs
$classes[0][7]="2"; //$coreqs
...
$classes[1][6]="0"; //$prereqs
$classes[1][7]="1"; //$coreqs
...
$classes[2][6]="0"; //$prereqs
$classes[2][7]="4"; //$coreqs
...
$classes[3][6]="0"; //$prereqs
$classes[3][7]="3"; //$coreqs
...
$classes[4][6]="0"; //$prereqs
$classes[4][7]="0"; //$coreqs	
...
$classes[5][6]="0"; //$prereqs
$classes[5][7]="0"; //$coreqs 		
//CS I 
$classes[6][0]="7";
...
$classes[6][6]="0"; //$prereqs
$classes[6][7]="0"; //$coreqs
	/* Assume pre-reqs outside of degree plan have already been taken
	$prereqs
...
$classes[7][6]="0"; //$prereqs
$classes[7][7]="0"; //$coreqs
...
$classes[8][6]="1"; //$prereqs
$classes[8][7]="10"; //$coreqs
...
$classes[9][6]="0"; //$prereqs
$classes[9][7]="9"; //$coreqs
...
$classes[10][6]="0"; //$prereqs
$classes[10][7]="0"; //$coreqs
...
$classes[11][6]="7"; //$prereqs
$classes[11][7]="1"; //$coreqs
...
$classes[12][6]="12"; //$prereqs
$classes[12][7]="0"; //$coreqs
...
$classes[13][6]="0"; //$prereqs
$classes[13][7]="0"; //$coreqs
...
$classes[14][6]="12"; //$prereqs
$classes[14][7]="0"; //$coreqs
...
$classes[18][6]="12"; //$prereqs
$classes[18][7]="0"; //$coreqs

//Elective
$classes[19][0]="20";
$classes[19][1]="COMP LEI";
$classes[19][2]="Elective I";
$classes[19][3]=3; //# of Credit Hours
$classes[19][4]=0; //Spring
$classes[19][5]="E"; //Required
$classes[19][6]="0"; //$prereqs
$classes[19][7]="0"; //$coreqs

//Elective
$classes[20][0]="21";
$classes[20][1]="COMP LEII";
$classes[20][2]="Elective II";
$classes[20][3]=3; //# of Credit Hours
$classes[20][4]=1; //Spring
$classes[20][5]="E"; //Required
$classes[20][6]="0"; //$prereqs
$classes[20][7]="0"; //$coreqs
//Govt I
$classes[21][0]="22";
...
$classes[21][6]="0"; //$prereqs
$classes[21][7]="0"; //$coreqs
//Science I
$classes[22][0]="23";
$classes[22][1]="SCI CIII";
...
$classes[24][6]="0"; //$prereqs
$classes[24][7]="0"; //$coreqs
...
$classes[25][6]="9"; //$prereqs
$classes[25][7]="0"; //$coreqs
...
$classes[26][6]="19"; //$prereqs
$classes[26][7]="0"; //$coreqs
...
$classes[27][6]="19"; //$prereqs
$classes[27][7]="0"; //$coreqs
...
$classes[28][6]="0"; //$prereqs
$classes[28][7]="0"; //$coreqs
...
$classes[29][6]="13,15"; //$prereqs
$classes[29][7]="0"; //$coreqs
...
$classes[34][6]="0"; //$prereqs
$classes[34][7]="36"; //$coreqs
...
$classes[35][6]="16,31,32"; //$prereqs
$classes[35][7]="35"; //$coreqs
...
$classes[36][6]="31"; //$prereqs
$classes[36][7]="0"; //$coreqs
...
$classes[37][6]="15"; //$prereqs
$classes[37][7]="0"; //$coreqs
...
$classes[38][6]="15"; //$prereqs
$classes[38][7]="0"; //$coreqs
...
$classes[39][6]="0"; //$prereqs
$classes[39][7]="0"; //$coreqs
...
$classes[40][6]="36"; //$prereqs
$classes[40][7]="0"; //$coreqs
...
$classes[43][6]="0"; //$prereqs
$classes[43][7]="0"; //$coreqs
//Humanities & Arts
$classes[44][0]="45";
$classes[44][1]="H&V CoreII";
$classes[44][2]="Humanitie & Ars II";
$classes[44][3]=3; //# of Credit Hours
$classes[44][4]=2; //Spring
$classes[44][5]="E"; //Required
$classes[44][6]="0"; //$prereqs
$classes[44][7]="0"; //$coreqs
